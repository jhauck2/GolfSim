...
class Camera:
    def __init__(self, pos, theta, f=0.0, cx=0.0, cy=0.0, source=None):
...
orien = np.array([[0.0], [0.0], [0.0]])

cam = Camera(pos=position, theta=orien, f=417.03, cx=137, cy=97)
